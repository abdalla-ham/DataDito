...
public class Login extends JFrame {
    ...
    private boolean authenticateUser(String phone, String password) {
        try {
            ...
            System.out.println("Raw server response: " + responseMessage);
            ...
            if (responseMessage.startsWith("{")) {
                ...
                JOptionPane.showMessageDialog(null, "Unexpected server response: " + responseMessage, "Error", JOptionPane.ERROR_MESSAGE);
...
public class Login extends JFrame {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                try (BufferedReader in = new BufferedReader(new InputStreamReader(conn.getInputStream()))) {
                    ...
                    if ("OK".equals(statusCode)) {
                        ...
                        JOptionPane.showMessageDialog(null, "Invalid credentials. Please try again.", "Authentication Failed", JOptionPane.ERROR_MESSAGE);
                        return false;
                    }
                }
            } else {
    ...
    private void handleErrorResponse(HttpURLConnection conn, int responseCode) {
        try (BufferedReader in = new BufferedReader(new InputStreamReader(conn.getErrorStream()))) {
            ...
            String message = errorResponse.optString("message", "An error occurred.");
            JOptionPane.showMessageDialog(null, "Error (" + responseCode + "): " + message, "Authentication Failed", JOptionPane.ERROR_MESSAGE);
        } catch (IOException e) {
            System.out.println("Failed to read error response: " + e.getMessage());
        }
    }
