package com.datadito.aom.repository;

import com.datadito.aom.exception.NotFoundException;
import com.datadito.aom.helper.OracleConnection;
import com.datadito.aom.request.CreateBalanceRequest;
import com.i2i.datadito.voltdb.VoltDbOperators;
import com.i2i.datadito.voltdb.VoltPackageDetails;
...
public class BalanceRepository {
     ...
     * @throws IOException
     */
    public ResponseEntity<String> createVoltBalance(CreateBalanceRequest createBalanceRequest) throws IOException, InterruptedException, ProcCallException {
        ...
        voltdbOperator.insertBalance(
                ...
                //add balance money and partition id
