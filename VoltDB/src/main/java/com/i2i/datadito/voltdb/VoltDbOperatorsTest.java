...
public class VoltDbOperatorsTest {
    ...
    public static void main(String[] args) {
        ...
        // Invoking methods
        try {
          System.out.println("Package Name: " + operators.getPackageName(msisdn+1));
           ...
           System.out.println("SMS Balance: " + operators.getSmsBalance(msisdn));
            System.out.println("Data Balance: " + operators.getDataBalance(msisdn+1));
           ...
           System.out.println("Package Data Balance: " + operators.getPackageDataBalance(msisdn));
            ...
            operators.updateSmsBalance(usage+59, msisdn);
